...
def boost_improver_scores(
    ...
    improver_boost_points: int = 15,
    strong_trip_boost_points: int = 5
) -> List[Dict[str, Any]]:
    """
    ...
    Args:
        ...
        improver_boost_points: Base boost for improver flag (default 15)
        strong_trip_boost_points: Additional boost for strong trip suitability (default 5)
...
def promote_improver_picks_to_official(
    ...
    min_win_probability_threshold: float = 0.15
    ...
    Args:
        ...
        min_confidence_threshold: Minimum confidence score (default 70)
        min_win_probability_threshold: Minimum win probability (default 0.15)
