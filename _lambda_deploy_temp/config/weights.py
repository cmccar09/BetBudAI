...
DEFAULT_WEIGHTS = {
    ...
    'sweet_spot': 10,
    'optimal_odds': 8,
    'favorite_correction': 8,
    'market_steam_bonus': 10,
    'market_drift_penalty': 6,
    'market_divergence_penalty': 18,  # ATOMIC FIX #4 (2026-05-12): increased from 14; model/market disagreement penalty
